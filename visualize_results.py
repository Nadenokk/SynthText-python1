...
Визуализация сгенерированной локализации синтетической
данные хранятся в базах данных h5
"""
...
     charBB_list: список матриц ограничивающего прямоугольника 2x4xn_i
     wordBB: матрица координат слов размером 2x4xm
    """
    plt.close(1)
    plt.figure(1)
    plt.imshow(text_im)
    ...
    for i in range(wordBB.shape[-1]):
        ...
        # визуализировать отдельные вершины:
        vcol = ['r','g','b','k']
        for j in range(4):
